            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-3 rtl:space-x-reverse">
                  ...
                  <button className="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors focus-visible">
