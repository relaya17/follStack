 ...
 *     tags: [AR Learning]
 */
export const getARContent = async (req: AuthRequest<{ lessonId: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
 ...
 *     tags: [AR Learning]
 */
export const updateARObject = async (req: AuthRequest<{ id: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { id } = req.params
 ...
 *     tags: [AR Learning]
 */
export const deleteARObject = async (req: AuthRequest<{ id: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
        const { id } = req.params
