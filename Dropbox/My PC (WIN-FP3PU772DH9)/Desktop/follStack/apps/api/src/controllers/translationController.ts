...
import { AuthenticatedRequest, TranslationRequest } from '@/types/express'
 ...
 */
export const translateText = async (req: TranslationRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 *     tags: [Neural Translation]
 */
export const detectLanguage = async (req: TranslationRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
    const { text } = req.body
 ...
 *     tags: [Neural Translation]
 */
export const getTranslationHistory = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
 ...
 *     tags: [Neural Translation]
 */
export const clearTranslationHistory = async (req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> => {
  try {
