...
import { ErrorBoundary } from '@/components/error/error-monitor'
...
export default function RootLayout({
  ...
  return (
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      <body className={`${inter.variable} ${heebo.variable} ${cairo.variable} min-h-screen bg-gradient-to-b from-emerald-50/20 via-emerald-50/10 to-white dark:from-gray-900 dark:to-gray-800`}>
        <ErrorBoundary>
          <Providers>
            {children}
            <AccessibilityButton />
